...
#define VEC2 PointCloudViewer::math::vec2
#define VEC3 PointCloudViewer::math::vec3
#define VEC4 PointCloudViewer::math::vec4
#define MAT4 PointCloudViewer::math::mat4x4
#define UINT1 uint32_t
#define UINT2 PointCloudViewer::math::uvec2
#define UINT3 PointCloudViewer::math::uvec3

#define USHORT uint16_t

#define PACKED_HALF4 PointCloudViewer::math::half4
#define PACKED_RGB10A2_UNORM PointCloudViewer::math::rgb10a2unorm
...
inline PointCloudViewer::math::vec3 shadowTransformsForward[6]
{
	VEC3(1.0f, 0.0f, 0.0f),
	VEC3(-1.0f, 0.0f, 0.0f),
	VEC3(0.0f, 1.0f, 0.0f),
...
inline PointCloudViewer::math::vec3 shadowTransformsUp[6]
{
	VEC3(0.0f, 1.0f, 0.0f),
	VEC3(0.0f, 1.0f, 0.0f),
	VEC3(0.0f, 0.0f, 1.0f),
